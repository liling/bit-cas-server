			...
			<form:form method="post" id="fm1" cssClass="fm-v clearfix" commandName="${commandName}" htmlEscape="true">
                ...
                <!-- <spring:message code="screen.welcome.welcome" /> -->
                    ...
                    <div class="row fl-controls-left">
						...
						<form:input cssClass="required osk-trigger" cssErrorClass="erro osk-triggerr" id="username" size="25" tabindex="1" accesskey="${userNameAccessKey}" path="username" autocomplete="false" htmlEscape="true" data-osk-options="disableReturn"/>
						</c:if>
                    </div>
                    <div class="row fl-controls-left">
						...
						<form:password cssClass="required osk-trigger" cssErrorClass="error osk-trigger" id="password" size="25" tabindex="2" path="password"  accesskey="${passwordAccessKey}" htmlEscape="true" autocomplete="off" data-osk-options="disableReturn"/>
                    </div>
